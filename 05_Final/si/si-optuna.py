...
def objective(trial):
    ...
    # 采样SI参数 - 基于原论文的范围
    lam0 = trial.suggest_float("lambda0", 1e-3, 1.0, log=True)
    lam1 = trial.suggest_float("lambda1", 1e-3, 1.0, log=True)
    lam2 = trial.suggest_float("lambda2", 1e-3, 1.0, log=True)
